...
$listedestination=$destinations->getdestinations(); 
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Listes des destinations</h1>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td><img style="height: 120px;width: 120px" src="<?php echo $v['image']; ?>"></img></td>
...
<a class="card bg-danger text-white  " type="button" href='deletedestination.php?id=<?php echo $v['id']; ?>'>Supprimer destination</a></div></td>
                                        </tr>
                                         <?php } ?>
                                    </tbody>
                                </table>
