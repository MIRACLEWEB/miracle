...
$listereservation=$destinations->getreservation(); 
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Résèrvation Sorties</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php  foreach($listereservation as $v) {?>
                                        <tr>
                                            <td><?php echo $v['name']; ?></td>
                                                   <td><?php echo $v['datee']; ?> - <?php echo $v['heure']; ?></td>
                                            <td><?php echo $v['email']; ?></td>
                                     
                                            <td><?php echo $v['tel']; ?></td>
                                                <?php  foreach( $destinations->getnomchauffeur($v['id_chauffeur']) as $d) {?>
                                            <td><?php echo $d['nom']; ?></td>
                                              <?php } ?>
                                                 <?php  foreach( $destinations->getnomdestination($v['id_destination']) as $p) {?>
                                            <td><?php echo $p['name']; ?></td>
                                              <?php } ?>


                                            <td>                                <div class="card bg-danger text-white mb-4">
<a class="card bg-danger text-white  " type="button" href='delete.php?id=<?php echo $v['id']; ?>'>Annuler reservation</a></div></td>
                                        </tr>
                                         <?php } ?>
                                    </tbody>
                                </table>
